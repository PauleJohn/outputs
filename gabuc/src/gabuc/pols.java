 ...
 * @author AICS-CEBU
 */
public class pols extends javax.swing.JFrame {

    /**
     * Creates new form pols
     */
    private Double val;
 ...
 setItem(item + "," + getcurrentitem());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pols.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
